...
model = inference.load_roboflow_model(model_id = "yolov11", api_key=api_key)
...
while video.isOpened():
    ...
    detections = sv.Detections.from_inference(results[0].predictions)
    ...
    with open('results.csv', 'a', newline='') as csvfile:
        ...
        for object_id, box in detections:
